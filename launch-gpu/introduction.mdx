...
<Tab title="NVIDIA V100">
  **Best for**: Development, small-scale training
  
  - **Memory**: 16GB/32GB HBM2
  - **Performance**: 125 TFLOPS (mixed precision)
  - **Use Cases**: Research, prototyping
  - **Pricing**: $1.50/hour (16GB), $2.00/hour (32GB)
</Tab>

<Tab title="NVIDIA RTX 4090">
  **Best for**: Gaming, creative workloads, development
