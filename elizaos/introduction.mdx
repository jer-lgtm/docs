...
<Tab title="Distributed Computing">
  **Leverage Comput3's GPU infrastructure**
  ...
  - Agents can utilize H100, A100, and other high-performance GPUs
...
<Tab title="AI Model Access">
  **Direct access to Comput3's AI models**
  ...
  - Agents can use DeepSeek, Hermes, Qwen3, and other models
...
|------------|-----------------|-----|---------|-------------|
| **Simple Task Agent** | RTX 4090 | 8GB | 20GB | $1.20 |
